...
_ROUTE_POLICIES: list[RoutePolicy] = [
    ...
    RoutePolicy(
        {"POST"},
        re.compile(r"^/v1/adoption/bootstrap-profile/apply$"),
        _ROLE_OPERATOR,
        "adoption_bootstrap_profile",
    ),
    ...
    RoutePolicy({"POST"}, re.compile(r"^/v1/agents/register$"), _ROLE_AGENT | _ROLE_OPERATOR, "agent_directory_register"),
    RoutePolicy({"PUT"}, re.compile(r"^/v1/agents/publish-policy$"), _ROLE_OPERATOR | _ROLE_APPROVER, "agent_publish_policy"),
    RoutePolicy({"POST"}, re.compile(r"^/v1/agents/worklogs/sync$"), _ROLE_OPERATOR, "agent_worklog_sync"),
    RoutePolicy({"POST"}, re.compile(r"^/v1/agents/capability-matrix/sync$"), _ROLE_OPERATOR, "agent_capability_sync"),
    RoutePolicy({"POST"}, re.compile(r"^/v1/agents/handoffs/sync$"), _ROLE_OPERATOR, "agent_handoff_sync"),
    RoutePolicy({"POST"}, re.compile(r"^/v1/agents/scorecards/sync$"), _ROLE_OPERATOR, "agent_scorecards_sync"),
    RoutePolicy({"POST"}, re.compile(r"^/v1/agents/provenance/[^/]+/rollback$"), _ROLE_OPERATOR | _ROLE_APPROVER, "agent_provenance_rollback"),
